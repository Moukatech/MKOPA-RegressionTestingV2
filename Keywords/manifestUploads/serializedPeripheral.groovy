...
@Keyword
def  serializedPeripheral() {



	//Creating a parameterized File Location Path
	String path = System.getenv('USERPROFILE')
	File fileGenerated=new File(path+"/git/MKOPA-RegressionTestingV2/Manifest Files/serializedPeripheral.csv")
	...
	if(!fileGenerated.exists())
	{
		...
		fileGenerated.append("UNIT SERIAL #,BOX # \r\n")
