...
WebUI.callTestCase(findTestCase('Products/Payment Plans/Cash Payment Plan/step_AddCashPaymentPlan'), [('delay') : '5', ('payment_PlanName') : 'AddNewCashPlanTest'
        , ('payment_PlanDisplayName') : 'Payment Plan Display Name Test', ('outletproducttype') : 'M-KOPA 300', ('total_Price') : '50'
