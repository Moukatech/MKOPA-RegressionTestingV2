...
not_run: WebUI.setText(findTestObject('Customer Module/Screen Customer/input_Payment Phone Number'), paymentPhoneNumber)
...
not_run: WebUI.setText(findTestObject('Customer Module/Screen Customer/input_Deposit Question Response Summary'), payDepositQuestion)
...
not_run: WebUI.setText(findTestObject('Customer Module/Screen Customer/input_Response source of Lighting'), responseSourceLighting)
