...
WebUI.verifyElementPresent(findTestObject('MKOPA IV Module/Customers Dashboard/image_Upgrade'), 5)

WebUI.delay(delay)

WebUI.mouseOver(findTestObject('MKOPA IV Module/Customers Dashboard/image_hamburger_menu'))

WebUI.verifyElementPresent(findTestObject('MKOPA IV Module/Customers Dashboard/button_Downgrade'), 5)
