...
WebUI.callTestCase(findTestCase('Common/step_SearchCustomer'), [('customerToSearch') : '25741294'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.getText(findTestObject('MKOPA IV Module/Return Current Device/message_EnterRequiredValue'))

WebUI.verifyElementPresent(findTestObject('MKOPA IV Module/Return Current Device/message_EnterRequiredValue'), 3)
