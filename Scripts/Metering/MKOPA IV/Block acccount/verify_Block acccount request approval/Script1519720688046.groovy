...
WebUI.click(findTestObject('MKOPA IV Module/Blocked accounts request for approval/dropDwn_Approval staus'))

WebUI.delay(2)

WebUI.click(findTestObject('MKOPA IV Module/Blocked accounts request for approval/select_Approval status', [('approvalStatus') : approvalStatus]))
...
WebUI.verifyElementPresent(findTestObject('MKOPA IV Module/Blocked accounts request for approval/Success message'), 2)
...
WebUI.verifyElementVisible(findTestObject('MKOPA IV Module/Blocked accounts request for approval/img_Blocked'))
