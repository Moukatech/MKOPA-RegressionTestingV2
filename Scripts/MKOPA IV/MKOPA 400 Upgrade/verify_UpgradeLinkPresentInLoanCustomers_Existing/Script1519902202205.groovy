...
WebUI.comment('Not d10g Finished Payment Cash Customer')
...
WebUI.comment('Not d10g Finished Payment Loan Customer')

WebUI.callTestCase(findTestCase('Common/step_SearchCustomer'), [('customerToSearch') : '24512449'], FailureHandling.STOP_ON_FAILURE)
