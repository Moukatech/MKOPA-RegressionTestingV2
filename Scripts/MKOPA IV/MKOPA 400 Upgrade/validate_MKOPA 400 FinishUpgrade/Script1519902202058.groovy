...
WebUI.getText(findTestObject('MKOPA IV Module/Create New Product/message_FinishUpgradeRequiredFields'))

WebUI.verifyElementPresent(findTestObject('MKOPA IV Module/Create New Product/message_FinishUpgradeRequiredFields'), 5)
