...
not_run: WebUI.click(findTestObject('Customer Module/Sell Add On/Dropdown_Sell add on'))

not_run: WebUI.delay(2)

not_run: WebUI.click(findTestObject('Customer Module/Sell Add On/select_Add On'))
...
WebUI.click(findTestObject('Customer Module/Sell Add On/select_Dealership', [('dealership') : dealership]))
