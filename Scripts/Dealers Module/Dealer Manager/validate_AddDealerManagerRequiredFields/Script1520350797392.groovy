...
WebUI.getText(findTestObject('Dealers Module/Dealer Managers/message_EnterRequiredFields'))

WebUI.verifyElementPresent(findTestObject('Dealers Module/Dealer Managers/message_EnterRequiredFields'), 0)
