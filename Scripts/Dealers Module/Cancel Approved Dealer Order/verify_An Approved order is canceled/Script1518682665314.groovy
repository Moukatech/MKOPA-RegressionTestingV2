...
BalanceAfter = WebUI.getText(findTestObject('Dealers Module/Order Administration/Text_AccountBalancefor dealer'))

WebUI.verifyNotEqual(BalanceAfter, BalanceBefore)
