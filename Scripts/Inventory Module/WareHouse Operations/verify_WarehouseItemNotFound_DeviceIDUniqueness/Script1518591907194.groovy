...
WebUI.callTestCase(findTestCase('Inventory Module/Common/List Warehouses Operations'), [('wareHouseCode') : 'PRD-LINE'], 
...
WebUI.verifyElementVisible(findTestObject('Inventory Module/Transfers Out/message_Itemnotfound'))
