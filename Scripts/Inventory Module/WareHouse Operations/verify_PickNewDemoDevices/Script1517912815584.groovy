...
WebUI.callTestCase(findTestCase('Inventory Module/Common/step_ViewDemoDevices'), [('serial_Number') : findTestData('Inventory/List Demo Devices').getValue(
            1, 1), ('delay') : '3', ('code') : findTestData('Inventory/List Demo Devices').getValue(2, 1), ('demo_device') : findTestData(
            'Inventory/List Demo Devices').getValue(3, 1)], FailureHandling.STOP_ON_FAILURE)
