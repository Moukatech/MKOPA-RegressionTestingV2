...
if (classification == 'Bundled') {
    WebUI.setText(findTestObject('Inventory Module/Add Item Type/input_Item Type'), bundleItem)

    WebUI.delay(2)

    WebUI.setText(findTestObject('Inventory Module/Add Item Type/input_Qty'), quantity)

    WebUI.click(findTestObject('Inventory Module/Add Item Type/button_Add'))
} else if (classification == 'Serialized') {
    WebUI.check(findTestObject('Inventory Module/Add Item Type/check_can be bundled'))

    WebUI.check(findTestObject('Inventory Module/Add Item Type/check_Can be repaired'))
} else if (classification == 'Non-Serialized') {
    WebUI.check(findTestObject('Inventory Module/Add Item Type/check_can be bundled'))
} else {
