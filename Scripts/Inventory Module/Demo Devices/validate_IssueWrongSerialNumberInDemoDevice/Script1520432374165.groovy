...
not_run: WebUI.verifyElementVisible(findTestObject('Inventory Module/Issue Demo Device/message_blanksave'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Inventory Module/Issue Demo Device/text_seraialnumber', [('WrongSerial') : WrongSerial]), 
    WrongSerial)

WebUI.click(findTestObject('Inventory Module/Issue Demo Device/button_Save'))

WebUI.verifyElementVisible(findTestObject('Inventory Module/Issue Demo Device/message_wrongserial'))
