...
WebUI.click(findTestObject('Inventory Module/Dispatched Orders/dropdown_OrderingOutlet'))
...
String order_Number = filter_Results

WebUI.verifyElementText(findTestObject('Inventory Module/Dispatched Orders/label_OrderNumber', [('order_Number') : filter_Results]), 
    filter_Results)
