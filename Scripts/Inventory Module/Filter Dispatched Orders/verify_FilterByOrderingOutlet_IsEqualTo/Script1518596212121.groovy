...
String ordering_Outlet = order_Number

WebUI.verifyElementText(findTestObject('Inventory Module/Dispatched Orders/label_OrderNumber', [('order_Number') : order_Number]), 
    order_Number)
